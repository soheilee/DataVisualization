...
class Ui_winMain(object):
    def setupUi(self, winMain):
        ...
        self.SelectedFile_textEdit = QtWidgets.QTextEdit(self.verticalLayoutWidget)
        self.SelectedFile_textEdit.setObjectName("SelectedFile_textEdit")
        self.verticalLayout.addWidget(self.SelectedFile_textEdit)
